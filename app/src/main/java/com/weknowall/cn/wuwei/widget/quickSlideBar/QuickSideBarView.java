package com.weknowall.cn.wuwei.widget.quickSlideBar;
...
import com.weknowall.cn.wuwei.widget.quickSlideBar.listener.OnQuickSideBarTouchListener;
...
public class QuickSideBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.text_10_0);
        mTextSizeChoose = context.getResources().getDimensionPixelSize(R.dimen.text_15_0);
        mItemHeight = context.getResources().getDimension(R.dimen.text_20_0);
        if (attrs != null) {
